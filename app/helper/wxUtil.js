...
function getOpenId (code) {
	return new Promise((resolve, reject) => {
		request.get(`https://api.weixin.qq.com/sns/oauth2/access_token?appid=${base.appid}&secret=${base.secret}&code=${code}&grant_type=authorization_code`, function (error, response, body) {
			if(error!==null){
